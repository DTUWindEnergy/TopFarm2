...
def test_energy_island():
    ...
    # TODO: investigate why linux test fail under 6% tolerance
    np.testing.assert_allclose(
        df.mean().values, np.array([*ref_mean.values()]), rtol=6.0e-2
    )


# TODO: deprecated folder examples; Delete the folder
# import importlib
# import os
# import pkgutil
# import warnings
