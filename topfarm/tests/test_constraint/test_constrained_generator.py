...
from openmdao.drivers.doe_generators import ListGenerator, UniformGenerator
import pytest
import numpy as np
...
@pytest.mark.parametrize('driver', [ConstrainedGenerator(UniformGenerator(10, seed=0)),
                                    ConstrainedDiscardGenerator(UniformGenerator(10, seed=0)),
                                    ConstrainedGenerator(DOE_lst()),
                                    ConstrainedDiscardGenerator(DOE_lst())])
...
@pytest.mark.parametrize('driver', [ConstrainedGenerator(UniformGenerator(10, 0)),
