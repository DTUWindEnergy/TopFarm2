...
class TopFarm(object):
    ...
    def __init__(self, turbines, cost_comp, min_spacing, boundary, boundary_type='convex_hull', plot_comp=None, minimize_cost=True,
        ...
        prob.model.add_objective('cost', scaler=[-1, 1][minimize_cost])
