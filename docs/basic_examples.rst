...
In this section, only the most basic components of TOPFARM are explained. In addition to the tutorial, the user can play around with the parameters in each notebook to see how these influence the results.
